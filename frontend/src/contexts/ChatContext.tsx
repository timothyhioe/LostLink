...
interface ChatContextType {
  ...
  unreadNotifications: Record<string, { senderName: string; content: string; timestamp: string }>
...
export function ChatProvider({ children }: { children: ReactNode }) {
  ...
  const [unreadNotifications, setUnreadNotifications] = useState<Record<string, { senderName: string; content: string; timestamp: string }>>({})
  ...
  const setSelectedConversation = (userId: string | null, userName?: string) => {
    setSelectedConversationId(userId)
    if (userId && userName) {
